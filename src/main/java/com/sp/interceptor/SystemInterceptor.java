...
//			 System.out.println("***********************************");
//			 System.out.println("未登录 或者 session超时！");
//			 System.out.println("请重现登录！");
//			 System.out.println("***********************************");
			 //防止出现两个重定向
			 if(modelAndView!=null){
				 if(modelAndView.getViewName()!=null&&!"".equals(modelAndView.getView())){
					 
					 if(modelAndView.getViewName().toString().indexOf("redirect:")<0){
